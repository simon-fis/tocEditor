...
public class RomanNumeral
{
	...
	// if (arabic < 1)
	// throw new
	// NumberFormatException("Value of RomanNumeral must be positive.");
	// if (arabic > 3999)
	// throw new
	// NumberFormatException("Value of RomanNumeral must be 3999 or less.");
	// num = arabic;
	// }
	 ...
	 */
	public static String intToRomanString(int num, boolean uppercase)
	{
		...
		return (uppercase) ? roman.toUpperCase() : roman.toLowerCase();
	}
